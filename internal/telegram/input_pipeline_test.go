...
func TestBuildSystemPrompt_WithoutDependencies(t *testing.T) {
	...
	prompt, err := bc.buildSystemPrompt("hello", nil, 0, 0, 0)
	if err != nil {
...
func TestBuildSystemPrompt_WithAgent(t *testing.T) {
	...
	prompt, err := bc.buildSystemPrompt("write some code", agent, 0, 0, 0)
	if err != nil {
		t.Fatalf("buildSystemPrompt() error = %v", err)
	}
...
func TestBuildSystemPrompt_AgentWithEmptyPrompt(t *testing.T) {
	...
	prompt, err := bc.buildSystemPrompt("hello", agent, 0, 0, 0)
	if err != nil {
		t.Fatalf("buildSystemPrompt() error = %v", err)
	}
